  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await requests.create({
        ...
        patientUsername: patientUsername.trim() || undefined,
    ...
    <div className={styles.page}>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        <div className={styles.field}>
          <label className={styles.label}>Patient Username</label>
          <input
            type="text"
            value={patientUsername}
            onChange={(e) => setPatientUsername(e.target.value)}
            placeholder="Enter their username (optional)"
        ...
        <button type="submit" disabled={loading || !hospitalId} className={styles.submit}>
